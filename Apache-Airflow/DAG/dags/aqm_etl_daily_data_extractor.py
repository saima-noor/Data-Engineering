...
with DAG(
    'prism_aqm_dwh_etl_daily_data_extractor',
    ...
    send_success_email = EmailOperator(
                ...
                subject='Daily ETL process for PRISM AQM DWH',
    ...
    sales_by_sku_fact_table_to_sales_by_brand_fact_table >> run_quality_checks_sales_fact

    run_quality_checks_sales_fact >> run_quality_checks_daily_sales_msr_fact
