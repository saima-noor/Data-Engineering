...
with DAG(
    'prism_aqm_dwh_etl_geo_daily_data_extractor',
    ...
    #             subject= 'Daily ETL process for PRISM GEO AQM DWH',
    #             html_content=""" <h1>Congratulations! Daily ETL for PRISM AQM DWH process has been completed.</h1> """,
    # )

    send_success_email = BashOperator(
        task_id='send_email',
        bash_command = 'echo "Congratulations! ETL for PRISM AQM DWH process has been completed." | mail -s "Daily ETL process for PRISM GEO AQM DWH" shafiqul.islam@apsissolutions.com'
    )
