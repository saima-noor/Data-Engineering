...
with DAG(
    'prism_aqm_dwh_etl_daily_data_extractor_hrms_pass_database',
    ...
    run_data_quality_checks = MySqlOperator(
                       task_id = 'run_data_quality_checks',
                       mysql_conn_id = "pass_aqm_dwh_database",
    ...
    #             subject='ETL process for PRISM HRM AQM DWH',
    #             html_content=""" <h1>Congratulations! ETL for PRISM AQM DWH process has been completed.</h1> """,
    # )

    send_success_email = BashOperator(
        task_id='send_email',
        bash_command = 'echo "Congratulations! ETL for PRISM AQM DWH process has been completed." | mail -s "Daily ETL process for PRISM HRM AQM DWH" shafiqul.islam@apsissolutions.com'
    )
    ...
    sys_users_table_to_sys_users_fact_table >> run_data_quality_checks

    run_data_quality_checks >> send_success_email
