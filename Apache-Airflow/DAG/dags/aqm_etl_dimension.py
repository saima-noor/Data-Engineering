...
default_args = {
    ...
    "start_date": datetime.datetime(2021, 8, 7),
    'retries': 1,
    'retry_delay': datetime.timedelta(seconds=5)
}

with DAG(
    'prism_aqm_dwh_etl_dimension',
    ...
    start_operator >> drop_routes_dimension_table
    ...
    loading_rtl_dimension_table >> run_quality_checks
