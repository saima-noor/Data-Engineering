...
with DAG(
    'prism_aqm_dwh_etl_sales_by_sku_fact',
    ...
    # delete_rows_from_sales_by_sku_fact_table = MySqlOperator(
    #                     task_id = 'delete_rows_from_sales_by_sku_fact_table',
    #                     mysql_conn_id = "aqm_dwh_server",
    #                     # sql = "DROP TABLE IF EXISTS daily_sales_msr_fact",
    #                     sql = "delete from sales_by_sku_fact where date between '2021-07-25' and '2021-07-25'",
    # )
    ...
    # start_operator >> delete_rows_from_sales_by_sku_fact_table
    #
    # delete_rows_from_sales_by_sku_fact_table >> query_manager_table_to_sales_by_sku_fact_table

    query_manager_table_to_sales_by_sku_fact_table >> run_quality_checks
