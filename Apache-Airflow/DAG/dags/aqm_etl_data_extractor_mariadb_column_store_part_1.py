...
# yesterday_date = datetime.datetime.strftime(datetime.datetime(2022, 4, 26), '%Y-%m-%d')
...
with DAG(
    'prism_aqm_dwh_etl_daily_data_extractor_mariadb_column_store_part_1',
    ...
    send_success_email = BashOperator(
        task_id='send_email',
        bash_command = 'echo "Congratulations! ETL for PRISM AQM DWH (1st process) has been completed." | mail -s "Daily ETL process for Mariadb Column store PRISM SALES AQM DWH" shafiqul.islam@apsissolutions.com'
    )
